                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a data-toggle="tooltip" data-placement="bottom"  title="Listar <?php echo $this->router->fetch_class(); ?>"
           ...
           <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header"><?php echo(isset($mensalista)? '<i class="ik ik-calendar ik-2x"></i> &nbsp;Data da última alteração: &nbsp;'.
                    formata_data_banco_com_hora($mensalista->mensalista_data_alteracao) : '' ) ?></div>
                    ...
                    <div class="card-body">
                       ...
                       <form class="forms-sample" name="form_core" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 mb-20">
                                <label>Sobrenome do mensalista</label>
                             ...
                             <div class="col-md-4 mb-20">
                                ...
                                <input type="text" class="form-control datepicker" id="datepicker" name="mensalista_data_nascimento" 
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-2 mb-20">
                                <label>CPF</label>
                                <input type="text" class="form-control cpf" name="mensalista_cpf" 
                            ...
                            <div class="col-md-2 mb-20">
                                <label>RG</label>
                                <input type="text" class="form-control" name="mensalista_rg" 
                            ...
                            <div class="col-md-2 mb-20">
                                ...
                                <input type="text" class="form-control phone_with_ddd" name="mensalista_telefone_fixo" 
                            ...
                            <div class="col-md-2 mb-20">
                                ...
                                <input type="text" class="form-control sp_celphones" name="mensalista_telefone_movel" 
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-2 mb-20">
                            <label>Cep</label>
                            <input type="text" class="form-control cep" name="mensalista_cep" 
                          ...
                          <div class="col-md-2 mb-20">
                            <label>Número</label>
                            <input type="text" class="form-control" name="mensalista_numero_endereco" 
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-2 mb-20">
                            <label>Estado</label>
                            <input type="text" class="form-control uf" name="mensalista_estado" 
                          ...
                          <div class="col-md-2 mb-20">
                            ...
                            <input type="number" class="form-control" name="mensalista_dia_vencimento" 
