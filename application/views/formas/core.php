           ...
           <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header"><?php echo(isset($forma)? '<i class="ik ik-calendar ik-2x"></i> &nbsp;Data da última alteração: &nbsp;'.
                    formata_data_banco_com_hora($forma->forma_pagamento_data_alteracao) : '' ) ?></div>
