     ...
     <div class="row">
      <div class="col-md-12">
        <div class="card">
           ...
           <div class="card-header"><?php echo(isset($mensalidade)? '<i class="ik ik-calendar ik-2x"></i> &nbsp;Data da última alteração: &nbsp;'.
           formata_data_banco_com_hora($mensalidade->mensalidade_data_alteracao) : '' ) ?></div>
                  ...
                  <select class="form-control mensalistas select2" name="mensalidade_mensalista_id" <?php echo (isset($mensalidade) ? 'disabled' : ''); ?>>
                    ...
                    <?php foreach ($mensalistas as $mensalista): ?>
                      ...
                      <?php if (isset($mensalidade)): ?>
                        ...
                        <option value="<?php echo $mensalista->mensalista_id . ' ' . $mensalista->mensalidade_data_vencimento ?>" <?php echo ($mensalista->mensalista_id == $mensalidade->mensalidade_mensalista_id ? 'selected' : '') ?>><?php echo $mensalista->mensalista_nome . '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;CPF&nbsp&nbsp;' . $mensalista->mensalista_cpf; ?></option>                                                

                        <?php else: ?>

                          <option value="<?php echo $mensalista->mensalista_id . ' ' . $mensalista->mensalidade_data_vencimento ?>"><?php echo $mensalista->mensalista_nome . '&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;CPF&nbsp&nbsp;' . $mensalista->mensalista_cpf; ?></option>
