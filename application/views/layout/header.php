...
<head>
    ...
    <title>Park Now &nbsp; | &nbsp; <?php echo (isset($titulo) ? $titulo : 'Um novo conceito em estacionamentos'); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo base_url('public/plugins/owl.carousel/dist/assets/owl.carousel.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('public/plugins/owl.carousel/dist/assets/owl.theme.default.css'); ?>">
    -->
